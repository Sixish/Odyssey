///*global jQuery, extend, OdysseySpriteIndexLoadedEvent*/
...
Odyssey.View.SpriteIndex = (function ($) {
    ...
    extend(OdysseySpriteIndex.prototype, new Odyssey.Events.EventDispatchInterface());
    ...
    OdysseySpriteIndex.load = function (src) {
        ...
        function handleLoadSuccess(data) {
            ...
            spriteIndex.dispatchEvent(new Odyssey.Events.SpriteIndexLoadedEvent());
        }
        // Send the request.
        $.ajax({
            url: src,
