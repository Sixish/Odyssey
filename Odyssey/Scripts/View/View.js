...
goog.provide('Odyssey.View.View');
Odyssey.View.View = (function () {
    "use strict";
    ...
    extend(OdysseyView.prototype, new Odyssey.Events.EventDispatchInterface());
     ...
     * @param {OdysseyNavigationList} navMenu the navigation menu view component to use.
     */
    OdysseyView.prototype.setNavigationMenu = function (navMenu) {
        this.navigationMenu = navMenu;
    };

    /**
     * Gets the navigation menu.
     * @returns {OdysseyNavigationList} the navigation menu view component.
     */
    OdysseyView.prototype.getNavigationMenu = function () {
