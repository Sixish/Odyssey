...
goog.provide('Odyssey.Controller.NavigationControl');
// TODO move from Controls.js to more specialized classes.
Odyssey.Controller.NavigationControl = (function ($) {
    "use strict";
    /**
     * @constructor
     */
    ...
    extend(OdysseyNavigationControl.prototype, new Odyssey.Events.EventDispatchInterface());
    extend(OdysseyNavigationControl.prototype, new Odyssey.View.ViewAttributor());
    extend(OdysseyNavigationControl.prototype, new Odyssey.Model.ModelAttributor());
